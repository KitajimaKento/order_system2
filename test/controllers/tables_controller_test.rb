...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { status: @table.status, table_ID: @table.table_ID } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { status: @table.status, table_ID: @table.table_ID } }
